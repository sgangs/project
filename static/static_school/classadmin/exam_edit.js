        ...
        $.ajax({
            ...
            success : function(jsondata){
                ...
                $.each(jsondata, function(){
                    ...
                    "<td><input type='text' class='form-control final' value='"+this.final+"' style='text-align:center;'/></td>"+
                    "<td><input type='text' class='form-control grade' value='"+this.grade+"' style='text-align:center;' /></td>"+
                    "<td><input type='text' class='form-control grade_point' value='"+this.point+"' style='text-align:center;' /></td>"+
...
function save_data(){
    ...
    if (isNaN(subjectid) ){
        ...
        $("tr.data").each(function() {
            var report_id = $(this).find('td:nth-child(1)').html();
