...
$('.submit').click(function(e) {
    swal({
        title: "Are you sure?",
        text: "Are you sure to add a new product group?",
        type: "warning",
        showCancelButton: true,
      // confirmButtonColor: "#DD6B55",
        confirmButtonText: "Yes, add new product group!",
        closeOnConfirm: true,
        closeOnCancel: true,
        html: false
    }, function(isConfirm){
        ...
        (function() {
            $.ajax({
                ...
                success : function(jsondata) {
                    ...
                    if (show_success){
                        swal("Hooray", "New product group added", "success");
                ...
                // handle a non-successful response
                error : function() {
                    swal("Oops...", "Recheck your inputs. There were some errors! Note, Product Group Names must be unique.", "error");
                }
            });
        }());
    }
