...
urlpatterns = [
    ...
    url(r'^newteacherprofile/$', views.registerStaff, {'called_staff_type': 'Teacher'}, name='new_teacher_profile'),
    url(r'^newadminprofile/$', views.registerStaff, {'called_staff_type': 'Admin'}, name='new_teacher_profile'),
