...
urlpatterns = [
    ...
    url(r'^journalgrouplist/$', views.master_list, {'type': 'Journal Group'}, name='journalgroup_list'),
    url(r'^paymentmodelist/$', views.master_list, {'type': 'Payment Mode'},name='paymentmode_list'),
    ...
    url(r'^newjournalgroup/$', views.master_new, {'type': 'Journal Group'}, name='journalgroup_new'),
    url(r'^newjournalentry/$', detailsViews.journalentry, name='journalentry_new'),
    url(r'^newpaymentmode/$', views.new_payment_mode, {'type': 'Payment Mode'}, name='paymentmode_new'),
    url(r'^incomestatement/$', views.income_statement, name='income_statement'),
