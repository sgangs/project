...
function updateInvoice() {
	...
	for (var a = document.querySelectorAll('table.inventory tbody tr'), i = 0; a[i]; ++i) {
		...
		raw_price=(unitrate)*quantity+vat*(quantity+free);
	...
	cells[4].innerHTML = document.querySelector('table.meta tr:last-child td:last-child span:last-child').innerHTML = parsePrice(net_total - parseFloatHTML(cells[3]) - parseFloatHTML(cells[5]));
